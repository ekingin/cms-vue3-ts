...
const contentConfig: IContentConfig = {
  ...
  propList: [
    ...
    { label: '现价格', prop: 'newPrice', type: 'money', width: '100', align: 'center' },
    { label: '状态', prop: 'status', type: 'slot', width: '80', align: 'center' },
    { label: '图片', prop: 'imgUrl', type: 'slot', width: '100', align: 'center' },
    { label: '发货地址', prop: 'address', width: '100', align: 'center' },
    { label: '库存', prop: 'inventoryCount', width: '100', align: 'center' },
